...
VkRenderingAttachmentInfo attachment_info(VkImageView view, VkClearValue* clearValue, VkImageLayout layout /*= VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL*/);

VkRenderingAttachmentInfo depth_attachment_info(VkImageView view, bool clearDepth,
    VkImageLayout layout /*= VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL*/);

VkRenderingInfo rendering_info(VkExtent2D renderExtent, VkRenderingAttachmentInfo* colorAttachment,
    VkRenderingAttachmentInfo* depthAttachment);

VkRenderingInfo rendering_info_depth_only(VkExtent2D renderExtent,
    VkRenderingAttachmentInfo* depthAttachment);
...
VkImageCreateInfo cubemap_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent, VkSampleCountFlagBits samples);
VkImageViewCreateInfo cubemap_imageview_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags);
VkImageCreateInfo texture_array_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent, VkSampleCountFlagBits samples, uint32_t layerAmount);
VkImageViewCreateInfo texture_array_imageview_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags, uint32_t layerAmount);
