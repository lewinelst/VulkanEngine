...
VkRenderingAttachmentInfo vkinit::depth_attachment_info(
    VkImageView view, bool clearDepth, VkImageLayout layout /*= VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL*/)
{
    ...
    depthAttachment.clearValue.depthStencil.depth = 1.0f; // revert to 0.0f for reverse depth planes
...
//< render_info
//> render_info
VkRenderingInfo vkinit::rendering_info_depth_only(VkExtent2D renderExtent,
    VkRenderingAttachmentInfo* depthAttachment)
{
    VkRenderingInfo renderInfo{};
    renderInfo.sType = VK_STRUCTURE_TYPE_RENDERING_INFO;
...
//> image_set
VkImageCreateInfo vkinit::texture_array_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent, VkSampleCountFlagBits samples, uint32_t layerAmount)
{
    VkImageCreateInfo info = {};
    info.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
    info.pNext = nullptr;
...
//> image_set
VkImageCreateInfo vkinit::cubemap_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent, VkSampleCountFlagBits samples)
{
    VkImageCreateInfo info = {};
    info.sType = VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO;
    info.pNext = nullptr;
...
VkImageViewCreateInfo vkinit::texture_array_imageview_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags, uint32_t layerAmount)
{
    // build a image-view for the depth image to use for rendering
    VkImageViewCreateInfo info = {};
    info.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
    ...
    info.subresourceRange.levelCount = 1;
    info.subresourceRange.baseArrayLayer = 0;
    info.subresourceRange.layerCount = layerAmount;
    info.subresourceRange.aspectMask = aspectFlags;
